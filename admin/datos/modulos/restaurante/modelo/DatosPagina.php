...
class DatosPagina{
	...
	public static function headerpage(){
		...
		if(!$menu==null){
			...
			$urlmenu=false;
				if($m->nombre=='acceder'){
					...
					$header.="<li class=\"li_menu ".Luis::currentpagemenu($m->ukr,$m->home)."\">";
		...
		if(isset($_SESSION["usuarioid"])){
			...
			$header.="<div class=\"mens_perf_nots09 mens_perf_nots09200\">";
			# imagen de perfil usuario
			$header.="<a class=\"usernoneviewcartbox\" href=\"".DatosPagina::confver("base")."perfil\">";
			...
			#carrito de compras
			$header.="<a href=\"javascript:void(0)\" id=\"open_opder_list\">";
