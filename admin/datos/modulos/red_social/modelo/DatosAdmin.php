	...
	public static function page_menu_list($page){
		...
		if($page==="red_social"){
			...
			if(isset($_GET["paginas"])){
				...
				if($_GET["paginas"]=="administrar_idioma"){
					$restaurant_a="opcionActivado";
					$restaurant_b="opcionulActivado";
				...
				if($_GET["paginas"]=="agregar_nuevas_palabras"){
					$restaurant_a="opcionActivado";
					$restaurant_b="opcionulActivado";
					$restaurant_e="opciontiendaActivado";
				}
			}
			...
			$lista_menu.='<a class="tienda opcion '.$restaurant_a.'" href="javascript:void(0);"><i class="icono__idioma"></i> '.Luis::lang("idiomas").'</a>';
			$lista_menu.='<ul class="ultienda '.$restaurant_b.'">';
			$lista_menu.='<li><a class="'.$restaurant_c.'" href="'.Luis::basepage("base_page_admin").'agregar_idioma">'.Luis::lang("nuevo_idioma").'</a></li>';
			$lista_menu.='<li><a class="'.$restaurant_e.'" href="'.Luis::basepage("base_page_admin").'agregar_nuevas_palabras">'.Luis::lang("agregar_nuevas_palabras").'</a></li>';
			$lista_menu.='<li><a class="'.$restaurant_d.'" href="'.Luis::basepage("base_page_admin").'administrar_idioma">'.Luis::lang("administrar_idiomas").'</a></li>';
			$lista_menu.='</ul>';
			$lista_menu.='</li>';
