...
$('.acctualizarusuario').click(function(){
var idl = i++;
let vh = $(".message").attr("btr");
 ...
 $.ajax({
  type: "POST",
  url: list_urls()+list_action()+"editarusuario",
  data:{"id":$('#id').val(),"linedefault":$("input[name='optionlog']:checked").val(),"sucursal":$("#sucursal_selected_users").val(),"nombre":$('#nombre').val(),"apellido":$('#apellido').val(),"dni":$('#dni').val(),"celular":$('#celular').val(),"direccion":$('#direccion').val(),"correo":$('#correo').val(),"pass":$('#pass').val()},
