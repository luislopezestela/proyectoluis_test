...
class Functions{
    ...
    public static function header_view(){
                            ...
                            $header.="<div class=\"perf_mens_subs_pl900 clperflleft\">";
                                ...
                                if($logotipclass){
                                    ...
                                    if(is_file($image_logo)) {
                                        ...
                                        $header.="<img class='logo_principal' src='".DatosPagina::confver("base")."/admin/datos/imagenes/pagina/gb".$logotipclass."'>";
                                    }
