...
$.fn.gMapsLatLonPicker = (function() {
	...
	_self.params = {
		...
		strings : {
			markerText : " Arrastra este marcador ",
			error_empty_field : "No se encontraron coordenadas para este lugar.",
			error_no_results : "No se encontraron coordenadas para este lugar."
		}
	};
...
//	console.log("guardado: " + $(object).attr('id') );
});